	...
	<section id="content">
		<div class="wrapper pad1">
			...
			<article class="col2">
					<div class="tabs2">
							<ul class="nav">
								<li class="selected"><a href="#Flight">Trace Your Cargo</a></li>
										...
										<div>
											...
											<div class="pad">
												...
												<div class="wrapper pad_bot1"><br>
													<span class="left">Enter your Cargo ID</span>
												
															<input type="text" name="item_number" class="input" value="00000"/>
                                                    ...
                                                    <br>
													<button name="trace" class="button1" type="submit" formaction="trace1.php">Trace your Package</button>
												</div>
											</div>
										</div>
									</form>
