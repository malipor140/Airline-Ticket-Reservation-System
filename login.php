                    ...
                    <article class="col2">
						...
						<form id="ContactForm" method="post">
							<div>
								...
								<br><button class="button1" type="submit" autofocus formaction="l1.php">Submit</button>
							</div>
						</form>
					</article>
					<article class="col3">
						...
						<form name="Contact" id="ContactForm" >
							<div>
								...
								<br><button class="button1" type="submit" autofocus formaction="l2.php">Submit</button>
