...
<td><select name="c2" id="c2"><option>January</option><option value="February">February</option><option>March</option><option>April</option><option selected="selected">May</option><option>June</option><option>July</option><option>August</option><option>September</option><option>October</option><option>November</option><option>December</option></select></td>
