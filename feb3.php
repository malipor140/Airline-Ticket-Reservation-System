			...
			<article class="col1">
				...
				<div class="box1">
					...
					<article class="col2">
						<br>
                        <br>
                       <h2>The 19th Dreamliner joins the Sky High fleet</h2>
                        <ul>
                        <li><p>The 19th B787 (VT-ANT) has been delivered to Air India on 17th February 2015.</p></li>
                        <li><p>The aircraft departed Charleston, USA on 23rd February 2015 and arrived in New Delhi on 24th February 2015.</p></li>
                        </ul>
					</article>
				</div>
			</section>
